...
class WC_Gateway_Paystack extends WC_Payment_Gateway_CC
{
	...
	public $test_public_ghana_key;
	public $test_secret_ghana_key;
	...
	public function __construct()
	{
		...
		$this->test_public_ghana_key = $this->get_option('test_public_ghana_key');
		$this->test_secret_ghana_key = $this->get_option('test_secret_ghana_key');
		...
		$currency_checker_live_public = $this->live_public_key;
		$currency_checker_live_secret = $this->live_secret_key;

		if (get_woocommerce_currency() == 'GHS') {
			$currency_checker_test_public = $this->test_public_ghana_key;
			$currency_checker_test_secret = $this->test_secret_ghana_key;

			$currency_checker_live_public = $this->live_public_ghana_key;
			$currency_checker_live_secret = $this->live_secret_ghana_key;
		}

		if (get_woocommerce_currency() == 'ZAR') {
			$currency_checker_test_public = $this->test_public_southafrica_key;
			$currency_checker_test_secret = $this->test_secret_southafrica_key;

			$currency_checker_live_public = $this->live_public_southafrica_key;
			$currency_checker_live_secret = $this->live_secret_southafrica_key;
		}

		if (get_woocommerce_currency() == 'KES') {
			$currency_checker_test_public = $this->test_public_kenya_key;
			$currency_checker_test_secret = $this->test_secret_kenya_key;

			$currency_checker_live_public = $this->live_public_kenya_key;
			$currency_checker_live_secret = $this->live_secret_kenya_key;
		}

		$this->public_key = $this->testmode ? $currency_checker_test_public : $currency_checker_live_public;
		$this->secret_key = $this->testmode ? $currency_checker_test_secret : $currency_checker_live_secret;
	...
	public function is_valid_for_use()
	{
		...
		if (!in_array(get_woocommerce_currency(), apply_filters('woocommerce_paystack_supported_currencies', array('NGN', 'USD', 'ZAR', 'GHS', 'KES')))) {
			...
			$this->msg = sprintf(__('Paystack does not support your store currency. Kindly set it to either NGN (&#8358), GHS (&#x20b5;), USD (&#36;), ZAR (R) or KES <a href="%s">here</a>', 'woo-paystack'), admin_url('admin.php?page=wc-settings&tab=general'));
	...
	public function get_icon()
	{
		...
		if ('GH' === $base_location['country'] || 'GHS' === get_woocommerce_currency()) {
			$icon = '<img style="height:100px;" src="' . WC_HTTPS::force_https_url(plugins_url('assets/images/paystack-gh.png', WC_PAYSTACK_MAIN_FILE)) . '" alt="Paystack Payment Options" />';
...
?>
		...
		?>
			<div class="inline error">
				<p><strong><?php _e('Paystack Payment Gateway Disabled', 'woo-paystack'); ?></strong>: <?php echo $this->msg; ?>
				</p>
			</div>
...
<?php
	...
	public function init_form_fields()
	{
		...
		$form_fields = array(
			...
			'test_secret_ghana_key'                  => array(
				'title'       => __('Test Secret Key Ghana', 'woo-paystack'),
				'type'        => 'text',
				'description' => __('Enter your Test Secret Key here', 'woo-paystack'),
				'default'     => '',
			),
			'test_public_ghana_key'                  => array(
				'title'       => __('Test Public Key Ghana', 'woo-paystack'),
				'type'        => 'text',
				'description' => __('Enter your Test Public Key here.', 'woo-paystack'),
				'default'     => '',
			),
			'live_secret_ghana_key'                  => array(
				'title'       => __('Live Secret Key Ghana', 'woo-paystack'),
				'type'        => 'text',
				'description' => __('Enter your Live Secret Key here.', 'woo-paystack'),
				'default'     => '',
			),
			'live_public_ghana_key'                  => array(
				'title'       => __('Live Public Key Ghana', 'woo-paystack'),
				'type'        => 'text',
				'description' => __('Enter your Live Public Key here.', 'woo-paystack'),
				'default'     => '',
			),
			...
			'test_public_southafrica_key'                  => array(
				'title'       => __('Test Public Key South Africa', 'woo-paystack'),
				'type'        => 'text',
				'description' => __('Enter your Test Public Key here.', 'woo-paystack'),
				'default'     => '',
			),
			'live_secret_southafrica_key'                  => array(
				'title'       => __('Live Secret Key South Africa', 'woo-paystack'),
				'type'        => 'text',
				'description' => __('Enter your Live Secret Key here.', 'woo-paystack'),
				'default'     => '',
			),
			'live_public_southafrica_key'                  => array(
				'title'       => __('Live Public Key South Africa', 'woo-paystack'),
				'type'        => 'text',
				'description' => __('Enter your Live Public Key here.', 'woo-paystack'),
				'default'     => '',
			),
			...
			'test_secret_kenya_key'                  => array(
				'title'       => __('Test Secret Key Kenya', 'woo-paystack'),
				'type'        => 'text',
				'description' => __('Enter your Test Secret Key here', 'woo-paystack'),
				'default'     => '',
			),
			'test_public_kenya_key'                  => array(
				'title'       => __('Test Public Key Kenya', 'woo-paystack'),
				'type'        => 'text',
				'description' => __('Enter your Test Public Key here.', 'woo-paystack'),
				'default'     => '',
			),
			'live_secret_kenya_key'                  => array(
				'title'       => __('Live Secret Key Kenya', 'woo-paystack'),
				'type'        => 'text',
				'description' => __('Enter your Live Secret Key here.', 'woo-paystack'),
				'default'     => '',
			),
			'live_public_kenya_key'                  => array(
				'title'       => __('Live Public Key Kenya', 'woo-paystack'),
				'type'        => 'text',
				'description' => __('Enter your Live Public Key here.', 'woo-paystack'),
				'default'     => '',
			),
	...
	public function admin_scripts()
	{
		...
		wp_enqueue_script('wc_paystack_admin', plugins_url(
			'assets/js/paystack-admin' . $suffix . '.js',
			WC_PAYSTACK_MAIN_FILE
		), array(), WC_PAYSTACK_VERSION, true);
	...
	public function process_payment($order_id)
	{
		...
		} elseif (isset($_POST['wc-' . $this->id . '-payment-token']) && 'new' !== $_POST['wc-' . $this->id .
			'-payment-token']) {
